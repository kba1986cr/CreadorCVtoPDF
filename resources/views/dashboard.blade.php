<x-app-layout>
    <x-slot name="header">
        <div class="bg-gray-100 dark:bg-gray-600 shadow rounded-lg px-4 py-6 sm:px-6 lg:px-8 border border-gray-200 dark:border-gray-300">
                ...
                <div
                    ...
                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        <div class="flex flex-col items-center">
                            ...
                            <a href="{{ route('profileDos.create') }}"
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div
                                        ...
                                        <div class="modal-header border-b border-gray-200 dark:border-gray-700">
                                            <h1 class="modal-title fs-5 font-semibold" id="exampleModalCreateLabel">
                                                Registro</h1>
